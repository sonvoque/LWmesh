...
${OBJECTDIR}/_ext/298884965/AES.p1: ../aes/aes_src/AES.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -flocal -maddrqual=require -DMBRTU -DBOOTABLE -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/sx1216/phy_inc" -I"../sys/sys_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -I"../aes/aes_inc" -I"../wdt/wdt_inc" -mwarn=-3 -Wa,-a -DXPRJ_MBbootable=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=hybrid:auto:auto:auto     -o ${OBJECTDIR}/_ext/298884965/AES.p1 ../aes/aes_src/AES.c 
