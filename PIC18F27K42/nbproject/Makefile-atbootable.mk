...
${OBJECTDIR}/_ext/669684871/mbfunccoils.p1: ../modbus/functions/mbfunccoils.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -maddrqual=require -mcodecov=ram -DATCOMM -DBOOTABLE -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/sx1216/phy_inc" -I"../sys/sys_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -mwarn=-3 -Wa,-a -DXPRJ_atbootable=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=hybrid:auto:auto:auto     -o ${OBJECTDIR}/_ext/669684871/mbfunccoils.p1 ../modbus/functions/mbfunccoils.c 
...
${OBJECTDIR}/_ext/669684871/mbfunccoils.p1: ../modbus/functions/mbfunccoils.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/669684871/mbfunccoils.p1.d 
	@${RM} ${OBJECTDIR}/_ext/669684871/mbfunccoils.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c    -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -maddrqual=require -mcodecov=ram -DATCOMM -DBOOTABLE -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/sx1216/phy_inc" -I"../sys/sys_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -mwarn=-3 -Wa,-a -DXPRJ_atbootable=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=hybrid:auto:auto:auto     -o ${OBJECTDIR}/_ext/669684871/mbfunccoils.p1 ../modbus/functions/mbfunccoils.c 
	@-${MV} ${OBJECTDIR}/_ext/669684871/mbfunccoils.d ${OBJECTDIR}/_ext/669684871/mbfunccoils.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/669684871/mbfunccoils.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
