...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/crc.c" 2
# 51 "mcc_generated_files/crc.c"
...
# 51 "mcc_generated_files/crc.c" 2

# 1 "mcc_generated_files/crc.h" 1
# 55 "mcc_generated_files/crc.h"
...
# 55 "mcc_generated_files/crc.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 56 "mcc_generated_files/crc.h" 2
...
# 52 "mcc_generated_files/crc.c" 2
...
_Bool CRC_SCAN_HasScanCompleted(void)
{
    ...
    _Bool status = (unsigned char)(PIR0bits.SCANIF && PIR0bits.CRCIF);
    if(status)
    {
        PIR0bits.CRCIF = 0;
        PIR0bits.SCANIF = 0;
