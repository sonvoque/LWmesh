...
# 2 "<built-in>" 2
# 1 "hal/hal_src/Timers.c" 2

# 1 "hal/hal_inc\\Timers.h" 1
# 10 "hal/hal_inc\\Timers.h"
...
# 2 "hal/hal_src/Timers.c" 2

# 1 "phy/sx1216/phy_inc\\phy.h" 1
# 19 "phy/sx1216/phy_inc\\phy.h"
...
__attribute__((inline)) uint16_t get_timer0base(uint16_t* timer){
    uint16_t tval;
    PIE3bits.TMR0IE = 0;;
    tval = *timer;
    PIE3bits.TMR0IE = 1;;
...
__attribute__((inline)) void set_timer0base(uint16_t* timer, uint16_t tval){
    PIE3bits.TMR0IE = 0;;
    *timer = tval;
    PIE3bits.TMR0IE = 1;;
}
