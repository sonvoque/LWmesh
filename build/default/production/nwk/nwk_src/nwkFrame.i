...
# 2 "<built-in>" 2
# 1 "nwk/nwk_src/nwkFrame.c" 2
# 48 "nwk/nwk_src/nwkFrame.c"
...
# 49 "nwk/nwk_src/nwkFrame.c" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 50 "nwk/nwk_src/nwkFrame.c" 2
...
# 51 "nwk/nwk_src/nwkFrame.c" 2

# 1 "sys/sys_inc\\sysConfig.h" 1
# 52 "nwk/nwk_src/nwkFrame.c" 2
...
static NwkFrame_t nwkFrameFrames[5];
...
NwkFrame_t *nwkFrameNext(NwkFrame_t *frame)
{
  ...
  for (; frame < &nwkFrameFrames[5]; frame++)
  {
