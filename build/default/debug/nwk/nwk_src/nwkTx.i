...
# 2 "<built-in>" 2
# 1 "nwk/nwk_src/nwkTx.c" 2
# 48 "nwk/nwk_src/nwkTx.c"
...
# 49 "nwk/nwk_src/nwkTx.c" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 50 "nwk/nwk_src/nwkTx.c" 2
...
# 52 "nwk/nwk_src/nwkTx.c" 2

# 1 "sys/sys_inc\\sysConfig.h" 1
# 53 "nwk/nwk_src/nwkTx.c" 2
...
# 59 "nwk/nwk_src/nwkTx.c" 2
# 68 "nwk/nwk_src/nwkTx.c"
enum
{
...
void nwkTxInit(void)
{
  nwkTxPhyActiveFrame = ((void*)0);

  nwkTxAckWaitTimer.interval = 200;
  nwkTxAckWaitTimer.mode = SYS_TIMER_INTERVAL_MODE;
  nwkTxAckWaitTimer.handler = nwkTxAckWaitTimerHandler;

  nwkTxDelayTimer.interval = 20;
...
void nwkTxBroadcastFrame(NwkFrame_t *frame)
{
  ...
  newFrame->tx.timeout = (rand() & 0x07) + 1;
  newFrame->tx.confirm = ((void*)0);
