...
# 2 "<built-in>" 2
# 1 "nwk/nwk_src/nwkRx.c" 2
# 48 "nwk/nwk_src/nwkRx.c"
...
# 49 "nwk/nwk_src/nwkRx.c" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 50 "nwk/nwk_src/nwkRx.c" 2
...
# 52 "nwk/nwk_src/nwkRx.c" 2

# 1 "sys/sys_inc\\sysConfig.h" 1
# 53 "nwk/nwk_src/nwkRx.c" 2
...
static _Bool nwkRxServiceDataInd(NWK_DataInd_t *ind);


static NwkDuplicateRejectionEntry_t nwkRxDuplicateRejectionTable[10];
...
static void nwkRxSendAck(NwkFrame_t *frame)
{
  ...
  if (((void*)0) == (ack = nwkFrameAlloc()))
    return;

  nwkFrameCommandInit(ack);

  ack->size += sizeof(NwkCommandAck_t);
  ack->tx.confirm = ((void*)0);
...
static _Bool nwkRxRejectDuplicate(NwkFrameHeader_t *header)
{
  NwkDuplicateRejectionEntry_t *entry;
  NwkDuplicateRejectionEntry_t *freeEntry = ((void*)0);
...
static void nwkRxHandleReceivedFrame(NwkFrame_t *frame)
{
  ...
  if (header->nwkFcf.multicast)
  {
    ...
    _Bool member = NWK_GroupIsMember(header->nwkDstAddr);
    _Bool broadcast = 0;
...
static _Bool nwkRxIndicateFrame(NwkFrame_t *frame)
{
  NwkFrameHeader_t *header = &frame->header;
  NWK_DataInd_t ind;

  if (((void*)0) == nwkIb.endpoint[header->nwkDstEndpoint])
    return 0;
...
static void nwkRxHandleIndication(NwkFrame_t *frame)
{
  ...
  if (0xffff == frame->header.macDstPanId)
    ack = 0;

  if (0xffff == nwkIb.addr)
    ack = 0;
